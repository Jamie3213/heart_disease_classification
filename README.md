...
1)  There is a noticeably larger proprotion of females in the subset of
    patients with heart disease;

2)  There is a clear difference between the types of chest pain
    experienced by those with and those without heart disease. Patients
    without heart disease primarirly experience typical angina, whilst
...
3)  There is almost no difference between the proportion of patients
    with and without a fasting blood sugar level of greater than 120
    mg/dl, between patients with and without heart disease;

4)  The proportion of patients with normal ECG results decreases and the
    proportion with abnomral ECG results increases between patients
    without heart disease and patients with heart disease;

5)  The proportion of patients without exercise induced angina is
    noticeably higher in patients with heart disease;

6)  For patients without heart disease, the slope of the ST curve peak
